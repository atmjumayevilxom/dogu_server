...
<main>
    <div class="container">
        <section class="product-text">
            <p class="text-1">ООО «Европейская Климатехника» является эксклюзивным представителем в России компании
                DOGU
                HVAC,
                производящей климатическое оборудование под
                торговой маркой FOUR SEASON с 1999 года. В рамках деятельности Вашей компании предлагаем стать нашим
                партнером для реализации продукции марки FOUR SEASONS.
            </p>
            <p>
                Мы поставляем широкий спектр систем вентиляции и промышленного кондиционирования с привлекательными
                условиями для дилеров:
            </p>
            ...
            <p class="text-3">
                ...
                <span>ISO 9001,ISO 14001, ISO 18001</span>
                Системы центрального кондиционирования воздуха имеют сертификаты
        ...
        <section class="main-center">
            ...
            <p class="text-5">
                За время работы в Узьекистане, наше оборудование было установлено на множество объектов в Ташкенте и
                Ташкентской области, а также ряде других городов Узбекистана, в том числе таких как
            </p>
            <div class="images-card">
                <h3>Завод "Uztex"</h3>
                <div class="img-yaroslav">
                    <img src="{{ asset('images/uztex.png')}}" alt="alt">
                    <img src="{{ asset('images/uztex.png')}}" alt="alt">
                </div>
                <h3>Фармацевтический завод «Биоком»</h3>
                <div class="img-san-peterburg">
                    <img src="{{ asset('images/biokom.jpg')}}" alt="alt">
                    <img src="{{ asset('images/biokom.jpg')}}" alt="alt">
                </div>
